...
//import "@css/components/contactusmodal.css";
...
const ContactUsModal = (props) => {
	...
	return (
		<dialog className="contact-us-modal__c section">
			...
			<div className={`contact-us-modal__form-wrapper fill-parent f-col ${modalVisible ? 'visible' :''}`}>
				...
				<form className={`contact-us-modal__form f-col`}
