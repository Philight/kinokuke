...
//import "@css/components/descriptionwithimage.css";

const DescriptionWithImage = (props) => {
	let { title, description, ctaText, linkTo, imageUrl, value1, value2, value3, autoplayDelay } = props;
