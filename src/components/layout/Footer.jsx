...
//	let { className, redirectUrl, socialFacebookUrl, socialInstagramUrl, title, subtitle, description, subdescription } = props;
	...
	return (
		<section className="footer__c f-col">
			...
			<div className="footer__bottom">
				<div className="footer__logo-slogan">
					...
					{IS_MOBILE && <span className="footer__logo-slogan-text">Lepší Začiatok.<br/>Lepší Domov.<br/><span>Lepší Život</span></span>}
					{!IS_MOBILE && <span className="footer__logo-slogan-text">Lepší Začiatok. Lepší Domov. <span>Lepší Život</span></span>}
				</div>
