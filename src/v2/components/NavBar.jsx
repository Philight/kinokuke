...
import KinoKukeLogo from './KinoKukeLogo.jsx';
import Icon from './Icon.jsx';
// import SectionHeading from "./SectionHeading.jsx";
// import HeadingUnderline from "./HeadingUnderline.jsx";
// import SectionSubheading from "./SectionSubheading.jsx";
...
const NavBar = (props) => {
  ...
  return (
    <div className={`nav-bar__container ${className} ${submenuShown ? 'submenu-shown' : ''}`}>
      <div className={scrollDown ? 'nav-bar__wrapper hidden' : 'nav-bar__wrapper'} ref={navRef}>
        <Link to='/v2' onClick={hideMenu}>
          <KinoKukeLogo className='menu-closed' />
          <KinoKukeLogo blackFill className='menu-open' />
        </Link>
        <div style={{ display: 'flex', alignItems: 'center' }}>
          ...
          />
          <Icon icon='x-mark' className='burger-menu-open show-mobile' onClick={handleBurgerShow} />
        </div>
