...
*/
  ...
  const models = [
    {
      ...
      modelImageSrc:
        'https://connect-homes.com/wp-content/uploads/2019/11/3d-1400x875-c-center.jpg',
    ...
    },
    {
      ...
      modelImageSrc:
        'https://connect-homes.com/wp-content/uploads/2019/10/C02-1400x875-c-center.jpg',
    ...
    },
    {
      ...
      modelImageSrc:
        'https://connect-homes.com/wp-content/uploads/2019/11/C03-1400x875-c-center.jpg',
      imageSrc: miamiFront
    },
    {
      title: 'Venezia',
  ...
  const handleWheel = (e) => {
    ...
    //    console.log('onWheel');
    //    console.log(parseInt(e.deltaY, 10));
    //    parseInt(e.deltaY, 10) > 0 ? setWheelDown(true) : setWheelDown(false);
  ...
  return (
    <div className={`models-page__container ${className}`} onWheel={(e) => handleWheel(e)}>
      {/*
