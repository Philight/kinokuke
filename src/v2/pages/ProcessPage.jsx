  ...
  const parallaxData = [
    {
      ...
      imageSrc:
        'https://connect-homes.com/wp-content/uploads/2020/01/1_process-1-scaled-1440x900-c-center.jpg'
    },
    {
      ...
      imageSrc:
        'https://connect-homes.com/wp-content/uploads/2020/01/design-1-scaled-1440x900-c-center.jpg'
    },
    {
      ...
      imageSrc:
        'https://connect-homes.com/wp-content/uploads/2020/01/permit-1-scaled-1440x900-c-center.jpg'
    },
    {
      title: 'Nasťahujte sa do svojho Kino Kuke Domova',
      text: 'Vítajte doma. Kľúče su Vaše a ostatné už necháme na Vás.',
      imageSrc:
        'https://connect-homes.com/wp-content/uploads/2020/01/laststep-1-1440x900-c-center.jpg'
    }
  ];
...
*/
  ...
  return (
    <div
      className={`process-page__container ${className}`}
